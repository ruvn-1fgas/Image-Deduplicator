...
namespace language
{
    ...
    */
    ...
    std::map<std::string, std::map<std::string, std::string>> dict = {
        {"en", {{"mainWindow.OpenDirButton", "Open directory"}, {"mainWindow.DirLabel", "Selected directory - "}, {"mainWindow.ExcludeDirButton", "Exclude directory"}, {"mainWindow.ExcludeDirLabel", "Excluded directories - "}, {"mainWindow.StartButton", "Start"}, {"mainWindow.StartButton.Error.NotChosenDir", "Select Directory"}, {"mainWindow.StartButton.Error.DirectoryNotExists", "Directory not exists"}, {"mainWindow.StartButton.Result.NoDuplicates", "Duplicates not found"}, {"mainWindow.StartButton.HashCalc", "Hash calculation - "}, {"mainWindow.StartButton.ImageCompare", "Image comparison - "}, {"mainWindow.OpenDialog.TitleBar", "Select Directory"}, {"mainWindow.OpenDialog.Cancel", "_Cancel"}, {"mainWindow.OpenDialog.Accept", "_Accept"}, {"mainWindow.OpenDialog.Selected.Text", "Selected directory - "}, {"mainWindow.ExcludeDialog.TitleBar", "Select Directory"}, {"mainWindow.ExcludeDialog.Cancel", "_Cancel"}, {"mainWindow.ExcludeDialog.Accept", "_Select Directory"}, {"mainWindow.ExcludeDialog.Error.NotChosenDir", "First select directory"}, {"mainWindow.ExcludeDialog.Error.DirectoryIsSubDir", "Selected directory is subdirectory of excluded directory"}, {"mainWindow.ExcludeDialog.Error.DirectoryAlreadyExcluded", "Directory already excluded"}, {"mainWindow.ExcludeDialog.Error.DirectoryNotSubDir", "Selected directory is not subdirectory of current directory"}, {"mainWindow.ExcludeDialog.Selected.Text", "Excluded directories - "}, {"mainWindow.SettingsDialog.TitleBar", "Settings"}, {"mainWindow.SettingsDialog.Cancel", "Cancel"}, {"mainWindow.SettingsDialog.Apply", "Apply"}, {"mainWindow.SettingsDialog.RecursiveLabel", "Recursive search"}, {"mainWindow.SettingsDialog.hashThresholdLabel", "Hash threshold"}, {"mainWindow.SettingsDialog.ThemeLabel", "App theme"}, {"mainWindow.SettingsDialog.ThemeLight", "Light"}, {"mainWindow.SettingsDialog.ThemeDark", "Dark"}, {"mainWindow.SettingsDialog.Language", "Language"}, {"duplWindow.PrevButton", "Previous"}, {"duplWindow.NextButton", "Next"}, {"duplWindow.ListBox.Label", "List "}, {"duplWindow.ListBox.RightClick.Open", "Open"}, {"duplWindow.ListBox.RightClick.Delete", "Delete"}, {"duplWindow.ListBox.OpenFile.Error.FileNotFound", "Image not found"}}},
        {"ru", {
                   ...
                   {"mainWindow.ExcludeDialog.Error.DirectoryNotSubDir", "Выбранная директория не является поддиректорией текущей директории"},
